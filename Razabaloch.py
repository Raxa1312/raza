...
{H}[*] Email       : MochRizkii@gmail.com
{H}[*] Ttl Bucin   : 26 JUNI 2020
{H}[*] ---------------------------------------------
{H}[*] Kadaluwarsa : SUKA SUKA SAYA
{H}[*] Status      : PREMIUM BOS
{K}[*] Author      : AHMAD RAZA
{H}[*] ---------------------------------------------

{O}[01]. crack  Name
{O}[02]. crack Follower
{O}[03]. crack following
		...
		try:
			for pw in pas:
				...
				if "userId" in str(x_jason):
					...
					print(f"""\r {H}[>]{C} {H}STATUS : {H}RIZKI LIVE
  {H}[>]{C} {H}NAMA: {H}{nama}{C}
